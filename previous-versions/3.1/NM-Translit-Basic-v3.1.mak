    ...
    object bndBandVirtNM1: TPDBand
      ...
      object MemoNM3: TPDMemo
        Script.Strings = (
          ...
          ''
            ...
            '+sum+'#39'&c='#39'+nomer+'#39'&Tn='#39'+t+'#39'>'#39';'
      ...
      object MemoNM4: TPDMemo
        Script.Strings = (
          ...
          #9#9
          '    end;'
          '// параметр XXXXXX должен соответствовать коду заведения!'
          
            'memoNM4.text := '#39'<QRcode https://netmonet.co/tip/XXXXXX?o=3&s='#39'+' +
            'sum+'#39'&c='#39'+nomer+'#39'&Tn='#39'+t+'#39'&en='#39'+s+'#39'>'#39';'
