  ...
  object Sheet1: TPDDocument
    ...
    object bndBandVirtNM3: TPDBand
      Script.Strings = (
          ...
          'begin if ([System.CashGroup.genRestSys]<>'#39#39') then bndBandVirtNM1' +
          '.visible:=true'
        '   else bndBandVirtNM1.visible:=false; '
        
          'if ([System.CashGroup.genRestSys]<>'#39#39') then bndBandVirtNM2.visib' +
          'le:=true'
        ...
        object MemoNM4: TPDMemo
          Script.Strings = (
            ...
            'var '
              ...
              'waiterName, tableName, checkSum, checkNumber, netmonetWaiterCode' +
              ', waiterNameTransliterated, tableNameTransliterated: String;'
            'counter: integer;'
            'symbol: char;'
            ''
            'begin'
            ...
            '//script version 4.1.0'
              ...
              'tableNameTransliterated + '#39'&en='#39' + waiterNameTransliterated + '#39'>' +
              #39';'
